...
#show: (doc) => report(
  author: "篠﨑 秀紀",
  title: "調理動詞に注目した中国語料理動画コーパスの構築と",
...
本研究は、調理に関する中国語動画を対象とし、字幕および音声からコーパスを構築し、その中で用いられる動詞の分析を通じて、ローカルLLMによる生成表現の改善を目指すものである。  
調理動画は日常的かつ実用的な語彙を含んでおり、自然言語処理における意味役割ラベルや生成制御に活用できる可能性を持つ。
